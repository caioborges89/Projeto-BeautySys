...
CREATE TABLE CAIXA(
	...
	DT_HR_FECHAMENTO SMALLDATETIME NULL,
...
CREATE TABLE COMANDA(
	...
	DESC_TOTAL DECIMAL(10,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE CRECEBER(
	...
	CONSTRAINT FK_COMANDA_3 FOREIGN KEY (FK_COMANDA) REFERENCES COMANDA(PK_CODIGO),
	CONSTRAINT FK_CLIENTE_2 FOREIGN KEY (FK_CLIENTE) REFERENCES CLIENTE(PK_CODIGO),	
	CONSTRAINT FK_FORMA_PAGTO_2 FOREIGN KEY(FK_FORMA_PAGTO) REFERENCES FORMA_PAGTO(PK_CODIGO)	
)
GO
CREATE TABLE SITUACAO_CHEQUE(
		PK_CODIGO INT NOT NULL,
		DESCRICAO NVARCHAR(30) NOT NULL,
		CONSTRAINT PK_CODIGO_SITUACAO_CHEQUE PRIMARY KEY (PK_CODIGO)
)
...
CREATE TABLE CHEQUE(
	...
	CONSTRAINT FK_SITUACAO FOREIGN KEY (FK_SITUACAO) REFERENCES SITUACAO_CHEQUE(PK_CODIGO)
)
GO
